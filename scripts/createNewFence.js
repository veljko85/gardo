function createNewFence(
  ...
  if (activeArrowSide == 1) {
    if (rightPosts[0].isVisible) {
      createRightFence(
        getAbsPosX(rightPosts[activeArrow]) + 0.93,
      ...
      createRightFence(
        getAbsPosX(rightPosts[activeArrow]) + 0.95,
        getAbsPosZ(rightPosts[activeArrow]),
        0,
        fenceType
      );
  ...
  if (activeArrowSide == 2) {
    if (rightPosts[0].isVisible) {
      createRightFence(
        ...
        getAbsPosZ(rightPosts[activeArrow]) - 0.93,
        Math.PI / 2,
        fenceType
      );
    } else {
      createRightFence(
        getAbsPosX(rightPosts[activeArrow]),
        getAbsPosZ(rightPosts[activeArrow]) - 0.95,
        Math.PI / 2,
        fenceType
      );
    }
